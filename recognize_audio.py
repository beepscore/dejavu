...
if __name__ == '__main__':
    ...
    djv.fingerprint_directory("data/mp3", [".mp3"])

    # Recognize audio from a file
    song = djv.recognize(
        # FileRecognizer, "data/mp3/Sean-Fournier--Falling-For-You.mp3"
        FileRecognizer, "data/mp3/chantix.mp3"
    )
    ...
    #     "data/mp3/Josh-Woodward--I-Want-To-Destroy-Something-Beautiful.mp3"
    # )
